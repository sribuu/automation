...
<MobileElementEntity>
   ...
   <name>Button_PilihBulanMulai</name>
   <tag></tag>
...
Pilih Bulan Mulai</value>
   ...
   <locator>//*[@class = 'android.view.View' and (@text = 'Dari Bulan
Pilih Bulan Mulai' or . = 'Dari Bulan
Pilih Bulan Mulai') and @resource-id = '']</locator>
