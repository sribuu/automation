...
<MobileElementEntity>
   ...
   <name>Button_BerapaAnggaran</name>
   <tag></tag>
...
0</value>
   ...
   <locator>//*[@class = 'android.view.View' and (@text = 'Berapa Anggaran kamu
Rp 
0' or . = 'Berapa Anggaran kamu
Rp 
0') and @resource-id = '']</locator>
