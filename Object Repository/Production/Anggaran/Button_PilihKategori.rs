...
<MobileElementEntity>
   ...
   <name>Button_PilihKategori</name>
   <tag></tag>
...
Pilih kategori</value>
   ...
   <locator>//*[@class = 'android.view.View' and (@text = 'Kategori
Pilih kategori' or . = 'Kategori
Pilih kategori') and @resource-id = '']</locator>
