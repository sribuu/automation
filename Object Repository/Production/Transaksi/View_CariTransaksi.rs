...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Cari Transaksi' or . = 'Cari Transaksi') and @resource-id = '']</locator>
